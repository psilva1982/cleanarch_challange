...
type OrderServiceClient interface {
	...
	ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderListResponse, error)
}
...
func (c *orderServiceClient) ListOrder(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	ListOrder(context.Context, *Blank) (*OrderListResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrder(context.Context, *Blank) (*OrderListResponse, error) {
